                    ...
                    {!link ? (
                      ...
                      <motion.div key="success" initial={{ opacity:0, scale:0.95 }} animate={{ opacity:1, scale:1 }} exit={{ opacity:0 }} style={{ display:"flex", flexDirection:"column", gap:16 }}>
                        ...
                        <div style={{ borderRadius:16, padding:4, background:"rgba(255,255,255,0.03)", border:"1px solid rgba(255,255,255,0.07)" }}>
                         ...
                         <p style={{ flex:1, fontSize:11, color:"#71717a", overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap", margin:0, fontFamily:"'JetBrains Mono',monospace" }}>{`localhost:5173/download/${link.split("/").pop()}`}</p>
                         ...
                         <button onClick={() => {const id = link.split("/").pop();
                             window.location.href = `http://localhost:5173/download/${id}`;}}
